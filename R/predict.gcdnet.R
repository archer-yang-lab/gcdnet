...
##' be made. NOTE: \code{newx} must be a matrix, \code{predict} function does
##' not accept a vector or other formats of \code{newx}.
...
##' model.
##' @param type type of prediction required.  \itemize{ \item Type
##' \code{"link"} gives the linear predictors for classification problems and
##' gives predicted response for regression problems.  \item Type
##' \code{"class"} produces the class label corresponding to the maximum
##' probability. Only available for classification problems.}
